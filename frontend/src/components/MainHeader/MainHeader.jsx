...
const MainHeader =()=>{
  ...
  const selectOptions = ['Option 1', 'Option 2', 'Option 3', 'Option 4', 'Option 5', 'Option 6', 'Option 7'];

    return (
      <section className={styles.main}>
        <div className={styles.contentcont}>
          <h1 className={`h1-bold ${styles.title}`}>
          ...
          <div className={styles.searchcont}>
            <form className={styles.form}>
              ...
              />
              <div className={styles.formbtn}><Button label="Browse" variant="blue" onClick={handleSubmit}/></div>
            </form>
          </div>
