    ...
    return (
      <section className="width">
        ...
        <p className="h4-medium">
          Please refresh or try again later. If the issue persists, contact
          support.
        </p>
      </section>
    );
          ...
          <div className={styles.proceed}>
            <div className={`${styles.check} h5-light`}>
              ...
              <p className={styles.advice}>
                The price of all chosen assets includes VAT.
                <br />
                <br /> You can apply promo code and complete the payment during
                the checkout.
              </p>
            </div>
            <Button
  ...
  if (cart.items.length <= 0) {
    return (
      <section className="width">
        ...
        <p className="h4-medium">
          Please add items to your cart and try again. If the issue persists,
          contact support.
        </p>
        <div className={`${styles.cancelContainer} ${styles.cancelEmtyCart}`}>
          <Button
            variant="outline-red"
            label="Cancel"
            onClick={() => navigate("/library")}
