        ...
        <section className={`height ${styles.main}`}>
          <div className={styles.container}>
            <div className={`h4-medium ${styles.textCont}`}>
              <p> <span>Join the community of Lens Distortion Contributors!</span></p>
              <p>
                <span>Shape the future.</span> Let’s build the most comprehensive Distortion
                Grids Database. Your shared distortion grids will make this
                resource even more valuable for the entire community.
              </p>
              <p>
                <span>Become a Contributor & Earn rewards.</span> Everyone who uploads
                distortion grids and gets them approved by our team becomes a
                valued contributor. You'll receive a <span> 15% discount promo code</span> for
                any purchase in the Distortion Grids Database as a token of our
              ...
              <p>
                <span>Let's push the boundaries of CG together!</span> Share your assets and
